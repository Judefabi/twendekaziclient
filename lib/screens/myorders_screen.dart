...
import 'package:twendekaziclient/screens/bids_screen.dart';
import 'package:twendekaziclient/screens/new_order.dart';
import 'package:twendekaziclient/screens/order_details.dart';
...
class _MyOrdersScreenState extends State<MyOrdersScreen> {
  ...
  Stream<List<Order>> getMyOrders() {
    return _firebaseFirestore
        .collection('orders')
        .where('orderownerid', isEqualTo: user!.uid)
        .snapshots()
        .map((snapshot) =>
